...
namespace VOL.Core.Filters
{
    public class ActionPermissionAttribute : TypeFilterAttribute
    {
            ...
            : base(typeof(ActionPermissionFilter))
        {
            ...
            {
                new ActionPermissionRequirement() { RoleIds = new int[] { roleId }, IsApi = isApi },
            };
        }

        public ActionPermissionAttribute(
            ActionRolePermission actionRolePermission,
            bool isApi = false
        )
            : base(typeof(ActionPermissionFilter))
        {
            ...
            Arguments = new object[]
            {
                new ActionPermissionRequirement() { RoleIds = roles.ToArray(), IsApi = isApi },
            };
        }
            ...
            : base(typeof(ActionPermissionFilter))
        {
            Arguments = new object[]
            {
                new ActionPermissionRequirement() { RoleIds = roleIds, IsApi = isApi },
            };
        }
        ...
        public ActionPermissionAttribute(
            ...
            : base(typeof(ActionPermissionFilter))
        {
            this.SetActionPermissionRequirement(
                tableName,
                tableAction,
                (roleIds ?? "").Split(",").Select(x => x.GetInt()).ToArray(),
                sysController,
                isApi
            );
        }
        ...
        private void SetActionPermissionRequirement(
            string tableName,
            ActionPermissionOptions tableAction,
            int[] roleId,
            bool sysController = false,
        ...
        {
            SetActionPermissionRequirement(
                tableName,
                tableAction,
                roleId == null ? null : new int[] { (int)roleId },
                sysController,
                isApi
            );
        }
