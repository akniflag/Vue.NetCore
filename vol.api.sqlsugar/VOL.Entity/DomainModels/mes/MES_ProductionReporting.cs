...
namespace VOL.Entity.DomainModels
{
    [Entity(
        TableCnName = "生产报工",
        TableName = "MES_ProductionReporting",
        DetailTable = new Type[] { typeof(MES_ProductionReportingDetail) },
        DetailTableCnName = "报工明细",
    ...
    public partial class MES_ProductionReporting : BaseEntity
    {
        ...
        [Navigate(NavigateType.OneToMany, nameof(ReportingID), nameof(ReportingID))]
