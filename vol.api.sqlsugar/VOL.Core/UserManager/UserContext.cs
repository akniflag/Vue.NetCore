    ...
    public class UserContext
    {
        ...
        public List<Permissions> GetPermissions(int roleId)
        {
            if (IsRoleIdSuperAdmin(roleId))
            {
                ...
                var permissions = DBServerProvider
                    .DbContext.Set<Sys_Menu>()
            ...
            lock (objId)
            {
                ...
                List<Permissions> _permissions = dbContext
                    .SqlSugarClient.Queryable<Sys_Menu>()
