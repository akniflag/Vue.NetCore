...
{
    public partial class MES_ProductionLineDeviceRepository
        : RepositoryBase<MES_ProductionLineDevice>,
            IMES_ProductionLineDeviceRepository
    {
        public MES_ProductionLineDeviceRepository(VOLContext dbContext)
            : base(dbContext) { }
