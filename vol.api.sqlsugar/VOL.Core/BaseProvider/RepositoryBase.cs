...
namespace VOL.Core.BaseProvider
{
        ...
        where TEntity : BaseEntity, new()
    {
        ...
        /// <returns></returns>
        public virtual ISugarQueryable<TFind> IQueryablePage<TFind>(
            int pageIndex,
            int pagesize,
            out int rowcount,
        ...
        /// <returns></returns>
        public virtual ISugarQueryable<TEntity> IQueryablePage(
        ...
        public virtual int Update<TSource>(TSource entity, bool saveChanges = false)
            where TSource : class, new()
        {
        ...
        /// <returns></returns>
        public virtual WebResponseContent UpdateRange<Detail>(
            TEntity entity,
        ...
        private string UpdateDetail<TDetail>(
            List<TDetail> list,
            string keyName,
            object keyValue,
        ...
        public virtual void Delete<T>(T model, bool saveChanges)
            where T : class, new()
        {
            DbContext.Deleteable(model).AddQueue();
            if (saveChanges)
        ...
        public virtual void AddWithSetIdentity<T>(T entity)
            where T : class, new()
        {
            DbContext.Insertable(entity).ExecuteReturnEntity();
        }
        ...
        public virtual void Add<T>(T entities, bool saveChanges = false)
            where T : class, new()
        {
        ...
        public virtual void AddRange<T>(List<T> entities, bool saveChanges = false)
            where T : class, new()
        {
            DbContext.Insertable(entities).AddQueue();
            if (saveChanges)
